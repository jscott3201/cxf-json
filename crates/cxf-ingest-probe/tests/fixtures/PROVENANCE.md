...
checksums are recorded in the local, Git-ignored
`_research/results/W-024.md` after verification.
...
matrix in the local, Git-ignored
`_research/W003-CXF-INGESTION-QUALIFICATION.md`. They use CXF vocabulary
...
D-024 and the local, Git-ignored
`_research/W005-FIXTURE-LICENSE-POLICY.md` govern additions. Automated
